...
@section('content')
    <form action="{{url("/users/$user->user_id/addresses")}}" method="post">
        ...
        <div class="row">
            <x-input label="Şehir" placeholder="Şehir giriniz" type="text" field="city"/>
            <x-input label="İlçe" placeholder="İlçe giriniz" type="text" field="district"/>
        </div>
        <div class="row">
            <x-input label="Posta kodu" placeholder="Posta kodunu giriniz" type="text" field="zipcode"/>
