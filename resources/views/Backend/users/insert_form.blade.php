                ...
                <form action="{{url("/users")}}" method="post">
                    ...
                    <div class="row">
                        <div class="col-lg-6">
                            ...
                            <input type="text" class="form-control" id="name" value="{{old('name')}}" name="name" placeholder="Ad soyad giriniz">
                            @error('name')
                        ...
                        <div class="col-lg-6">
                            ...
                            <input type="email" class="form-control" id="email" value="{{old('email')}}" name="email" placeholder="Email giriniz">
                            @error('email')
                            <span class="text-danger">{{$message}}</span>
                            @enderror
                        </div>
