...
class ProductImageController extends Controller
{
    ...
    {
        $addrs = $user->addrs;
        return view('Backend.images.index', compact('addrs','user'));
    }
    ...
    {
        return view('Backend.images.insert_form',compact('user'));
    }
    ...
    {
        return view('Backend.images.update_form', compact('address','user'));
    }
